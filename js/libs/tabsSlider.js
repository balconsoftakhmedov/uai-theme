 class TabsSlider {
  ...
  constructor(elem, options) {
    ...
    this.tabs = elem;
    // if (!this.tabs || this.tabs.activated) {
    //   console.log(88989899899);
    //   return
    // };
...
const allTabsSection = document.querySelectorAll('.js_tabs__section');
[...allTabsSection][0].classList.add('tabs__section--active')

document.querySelector('.tabs').addEventListener('tabChange', function (evt) {
  allTabsSection.forEach(section => {
    section.classList.remove('tabs__section--active')
  })
  evt.detail.currentSlide.classList.add('tabs__section--active')
});
