...
window.onload = function () {
	...
	document.querySelector('.e-loadholder').classList.add('none');
	document.querySelector('#particleCanvas-Blue').classList.add('none');
	document.querySelector('#particleCanvas-White').classList.add('none');
}